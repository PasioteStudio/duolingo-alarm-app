...
public class AlarmEntity {
	...
	/**
	 * A personalised duolingo done message for the alarm.
	 */
	public String alarmDuolingo;
	...
	public AlarmEntity(int alarmHour, int alarmMinutes, boolean isAlarmOn,
		...
		String alarmMessage,String alarmDuolingo,
		...
		this.alarmDuolingo = alarmDuolingo;
	...
	public Bundle getAlarmDetailsInABundle() {
		...
		data.putString(ConstantsAndStatics.BUNDLE_KEY_ALARM_DUOLINGO, alarmDuolingo);
