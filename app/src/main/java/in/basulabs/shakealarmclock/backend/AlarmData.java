...
public class AlarmData {
	...
	public AlarmData(boolean isSwitchedOn, @NonNull LocalDateTime alarmDateTime,
		int alarmType, @Nullable String alarmMessage,@Nullable String Duolingo_Done) {
		...
		this.Duolingo_Done = Duolingo_Done;
	}
	...
	public AlarmData(boolean isSwitchedOn, @NonNull LocalTime alarmTime, int alarmType,
		@Nullable String alarmMessage,@Nullable String Duolingo_Done,
	...
	/**
	 * Set the duolingo done message.
	 *
	 * @param Duolingo_Done The duolingo done message. May be {@code null}.
	 */
	public void setDuolingo_Done(@Nullable String Duolingo_Done) {
		this.Duolingo_Done = Duolingo_Done;
	}
	...
	/**
	 * Get the duolingo done message. May be {@code null}.
	 *
	 * @return Same as in description.
	 */
	@Nullable
	public String getDuolingo_Done() {
		return Duolingo_Done;
	}
