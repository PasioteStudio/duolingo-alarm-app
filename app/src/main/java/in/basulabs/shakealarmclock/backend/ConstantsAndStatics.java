...
public final class ConstantsAndStatics {
	...
	/**
	 * Bundle key for the personalised duolingo message.
	 */
	public static final String BUNDLE_KEY_ALARM_DUOLINGO =
			"in.basulabs.shakealarmclock.ALARM_DUOLINGO";
	...
	/**
	 * {@link android.content.SharedPreferences} key to store the default duolingo username
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_DUOLINGO_USERNAME =
			"in.basulabs.shakealarmclock.DEFAULT_DUOLINGO_USERNAME";
