...
public class ViewModel_AlarmDetails extends ViewModel {
	 ...
	 * The message that will be displayed when the alarm rings. May be {@code null}.
	 */
	private MutableLiveData<String> alarmDuolingo;
	 ...
	 */
	@Nullable
	public String getAlarmDuolingo() {
		if (alarmDuolingo == null) {
			alarmDuolingo = new MutableLiveData<>(null);
		}
		return alarmDuolingo.getValue();
	}
	//------------------------------------------------------------------------------------------------------
	 ...
	 * Set the alarm message.
	 *
	 * @param alarmDuolingo The alarm message to be set. May be {@code null}.
	 */
	public void setAlarmDuolingo(@Nullable String alarmDuolingo) {
		if (this.alarmDuolingo == null) {
			this.alarmDuolingo = new MutableLiveData<>();
		}
		this.alarmDuolingo.setValue(alarmDuolingo);
	}
}
