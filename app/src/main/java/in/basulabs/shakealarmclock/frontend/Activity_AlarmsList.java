...
public class Activity_AlarmsList extends AppCompatActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Duolingo_APi();
		getSupportActionBar().setTitle(getResources().getString(R.string.app_name)+" "+Duo);
		...
		viewModel.init(alarmDatabase,Duo);
		...
		updateButton.setOnClickListener(view -> {
			Duolingo_APi();
			getSupportActionBar().setTitle(getResources().getString(R.string.app_name)+" "+Duo);
			toastText=getResources().getString(R.string.updated);
			showToast();
		});
	...
	private void setAlarm(@NonNull Bundle data) {
		...
		data.remove(BUNDLE_KEY_ALARM_DUOLINGO);
		data.putString(BUNDLE_KEY_ALARM_DUOLINGO,Duo);
				...
				if (result.getResultCode() == RESULT_OK) {
					...
					if (intent != null) {
						...
						AlarmEntity alarmEntity = new AlarmEntity(
							...
							data.getString(ConstantsAndStatics.BUNDLE_KEY_ALARM_DUOLINGO),
							data.getBoolean(
